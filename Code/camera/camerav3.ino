...
#define CAMERA_POWER 24 // Pin that control the camera power.
#define SD_POWER 23     // Pin that controls the SD card power.
...
void setup() {
  ...
  digitalWrite(CAMERA_POWER, LOW); // Have the camera be on by default.
  digitalWrite(SD_POWER, LOW);     // Have the SD card be on by default.
...
#ifdef DEVMODE
  Serial.println("Entering low-power mode and turning off the SD and the camera...");
#endif
